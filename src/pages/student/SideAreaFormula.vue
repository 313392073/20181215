...
<div class="wrapper">
    <div class="left-wrapper">
        <div class="left-box">
            <div class="desc-menu"><i class="iconfont icon-2fanhui" @click="goBack"></i>正棱锥侧面积</div>
            <!-- 主要内容 -->
            <div class="main-wrapper">
                <h3 class="title">侧面积公式<a class="refresh-btn" href="javascript:void(0)"><img @click="getrefresh" src="../../assets/images/refresh.png" alt="refresh.png"></a></h3>
